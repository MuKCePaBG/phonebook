    ...
    public class PhonesManagerView
    {
        ...
        private PhoneManagementEnum RenderMenu()
        {
            while (true)
            {
                ...
                var list = new List<KeyValuePair<string, PhoneManagementEnum>>
                {
                    new KeyValuePair<string, PhoneManagementEnum>("G", PhoneManagementEnum.Select),
                    new KeyValuePair<string, PhoneManagementEnum>("A", PhoneManagementEnum.Insert),
                    new KeyValuePair<string, PhoneManagementEnum>("D", PhoneManagementEnum.Delete),
                    new KeyValuePair<string, PhoneManagementEnum>("X", PhoneManagementEnum.Update)
                };
